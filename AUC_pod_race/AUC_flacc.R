...
raw_data <- read_excel("/Users/wonny/Downloads/CHMC/AUC pod race/DATA/pain scores flacc_12152022.xlsx") %>% as.data.frame
add_data <- read_excel("/Users/wonny/Downloads/CHMC/AUC pod race/DATA/pain scores flacc_01052023.xlsx") %>% as.data.frame
...
# save(raw_data, file="/Users/wonny/Downloads/CHMC/Pain AUC/pod_race_result/raw_data_flacc.rda")
...
AUC_ftn <- function(data_input, count_input){
  ...
  ps_vec <- data_input$FLACC_SCORE # pain score
...
# save
race_auc_result <- result
save(race_auc_result, count_matrix, file="race_auc.rda" )

## check ##

#which(result$Duration0<0)
# > which(result$Duration0<0)
# [1]   10   32  117  158  181  185  190  223  231  287  315  396  469  471
# [15]  474  521  553  579  628  644  685  709  720  729  732  739  776  905
# [29]  955  957  974 1057 1081 1137 1198 1204 1269 1273 1314 1327 1472 1492
# [43] 1503 1586 1648 1675 1692 1719 1728 1739 1761 1785 1812 1857 1863 1901
# [57] 1939 2014


# which(result$AUC1<0)
# > which(result$AUC1<0)
# [1]  231  474  729  732  955 1081 1137 1198 1204 1269 1273 1492

# which(result$AUC1>240)
# > which(result$AUC1>240)
# [1]  374 1948
