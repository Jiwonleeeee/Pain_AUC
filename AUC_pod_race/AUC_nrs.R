...
raw_data <- read_excel("/Users/wonny/Downloads/CHMC/AUC pod race/DATA/pain scores nrs_12152022.xlsx") %>% as.data.frame
add_data <- read_excel("/Users/wonny/Downloads/CHMC/AUC pod race/DATA/pain scores nrs_01052023.xlsx") %>% as.data.frame

raw_data <- subset(raw_data, select=-time)
...
# save(raw_data, file="/Users/wonny/Downloads/CHMC/Pain AUC/pod_race_result/raw_data_nrs.rda")
...
# save(result, count_matrix, file="race_auc_nrs.rda" )
