...
load(file="raw_data_flacc_nrs.rda")
...
which(Merge_temp$newID=="ID71")
Merge_temp <- Merge_temp[-72,]

which(Merge_temp$newID=="ID584")
Merge_temp <- Merge_temp[-585,]

which(Merge_temp$newID=="ID1174")
Merge_temp <- Merge_temp[-1175,]


# IDduplicateSet_flacc_nrs <- subset(raw_data, newID=="ID1174" | newID=="ID584" | newID=="ID71")
# save(IDduplicateSet_flacc_nrs, file="/Users/wonny/Downloads/CHMC/Pain AUC/pod_race_result/diffendtime_flacc_nrs.rda")
...
write.xlsx(Merge_data, sheetName="sheet1", file="AUC_pod_flacc_nrs.xlsx")
